...
public class EffectsConfig {
    public float rage_rage_attribute_increase_per_stack = 0.05f;
    public float rage_attack_speed_increase_per_stack = 0.01f;
    public int rage_max_amplifier_stack = 10;
    public float soul_devourer_heal_on_kill_target_max_health_amount = 0.10F;
